...
// Sample events data from seed.js
const SAMPLE_EVENTS = [
  {
  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-6">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold mb-2">Seed Events Data</h1>
          <p className="text-muted-foreground">
            This page displays all {SAMPLE_EVENTS.length} sample events from{" "}
          ...
          <div className="mt-4 p-4 bg-muted/50 rounded-lg">
            <p className="text-sm text-muted-foreground">
              <strong>Note:</strong> To seed the database, go to Convex Dashboard
            ...
            >
              ...
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-3">
                  ...
                  <Badge
                    variant={event.ticketType === "free" ? "default" : "outline"}
                  >
        ...
        <div className="mt-12 p-6 bg-muted/50 rounded-lg">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div>
              ...
              <p className="text-2xl font-bold">{SAMPLE_EVENTS.length}</p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground">Free Events</p>
              <p className="text-2xl font-bold">
                {SAMPLE_EVENTS.filter((e) => e.ticketType === "free").length}
              </p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground">Paid Events</p>
              <p className="text-2xl font-bold">
                {SAMPLE_EVENTS.filter((e) => e.ticketType === "paid").length}
              </p>
            </div>
            <div>
              <p className="text-sm text-muted-foreground">Total Capacity</p>
              <p className="text-2xl font-bold">
                {SAMPLE_EVENTS.reduce((sum, e) => sum + e.capacity, 0)}
              </p>
            </div>
          </div>
        </div>
